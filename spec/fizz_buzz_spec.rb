...
describe 'fizz_buzz' do
  ...
  it "returns 'Wrong input' if number is not a positive number" do
    expect(fizz_buzz(-1)).to eq 'Wrong input'
  end

  it "returns 'You should enter a number' if number is a string" do
    expect(fizz_buzz(String)).to eq 'You should enter a number'
  end
